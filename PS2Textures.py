...
How to UnSwizzle:
    ...
    4bpp type 2:
        Method 1:
            unsiwzzleBuffer = unswizzle4(swizzleBuffer, width, height)

        Method 2: Convert 4bpp to 8bpp
            swizzle8bppBuffer = convert4bppto8bpp(swizzle4bppBuffer, width, height)
            rrw = width // 2
            rrh = height // 2
            PSMCT32Buffer = writeTexPSMCT32(0, rrw // 64, 0, 0, rrw, rrh, swizzle8bppBuffer)
            unswizzle8bppBuffer = readTexPSMT8(0, width // 64, 0, 0, width, height, PSMCT32Buffer)

    8bpp:
        Method 1:
            unsiwzzleBuffer = unswizzle8(swizzleBuffer, width, height)

        Method 2:
            rrw = width // 2
            rrh = height // 2
            PSMCT32Buffer = writeTexPSMCT32(0, rrw // 64, 0, 0, rrw, rrh, swizzleBuffer)
            unsiwzzleBuffer = readTexPSMT8(0, width // 64, 0, 0, width, height, PSMCT32Buffer)
...
# Found here: http://gtamodding.ru/wiki/TIM2
